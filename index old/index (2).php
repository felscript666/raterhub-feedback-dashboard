        ...
        <form method="POST" class="form-grid">
            ...
            <div class="form-group">
                ...
                <div class="input-icon">
                    <span>🔍</span>
                    <input type="text" name="query_text" placeholder="Masukkan query..." required>
                </div>
            </div>

            <div class="form-group">
                <label>Web Label</label>
                <div class="input-icon">
                    <span>🌐</span>
                    <input type="text" name="web_label" placeholder="Nama website..." required>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-icon">
                    <span>🔗</span>
                    <input type="url" name="lp_link" placeholder="https://..." required>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-icon">
                    <span>⭐</span>
                    <input type="text" name="nm_rating" placeholder="Ex: High / Medium">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-icon">
                    <span>📊</span>
                    <input type="text" name="pq_rating" placeholder="Ex: High / Low">
                </div>
            </div>
